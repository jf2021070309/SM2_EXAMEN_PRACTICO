        ...
        child: Form(
          ...
          child: Column(
            children: [
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          ...
                          backgroundImage:
                              (_nuevaImagenPerfil != null)
                                  ...
                                  : (_urlImagenPerfil != null &&
                                      _urlImagenPerfil!.isNotEmpty)
                                  ? NetworkImage(_urlImagenPerfil!)
                                  : null,
                          child:
                              (_nuevaImagenPerfil == null &&
                                      (_urlImagenPerfil == null ||
                                          _urlImagenPerfil!.isEmpty))
                                  ? Text(
                        ...
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap:
                                _subiendoImagen ? null : _mostrarOpcionesImagen,
                            child: Container(
              ...
              // Botones de acción
              // Botón para abrir historial de inicios de sesión
              ElevatedButton.icon(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => LoginHistoryView(userId: widget.userId),
                    ),
                  );
                },
                icon: const Icon(Icons.history),
                label: const Text('Historial de inicios de sesión'),
