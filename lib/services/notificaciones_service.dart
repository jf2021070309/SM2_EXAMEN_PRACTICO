...
class NotificacionesService {
  ...
  Future<void> programarRecordatorio({
    ...
    final fechaNotificacion = fechaInicio.subtract(
      Duration(minutes: minutosAntes),
    );
    ...
    print(
      'fechaNotificacion.isBefore(ahora): ${fechaNotificacion.isBefore(ahora)}',
    );
    print(
      'Diferencia en minutos: ${fechaNotificacion.difference(ahora).inMinutes}',
    );
    print('==================');
    ...
    if (fechaNotificacion.isBefore(DateTime.now())) {
      print(
        'No se puede programar notificación en el pasado para $nombreActividad',
      );
      return;
    }
    ...
    try {
      ...
      print(
        'Notificación programada para $nombreActividad en $minutosAntes minutos antes',
      );
  ...
  Future<void> mostrarNotificacionInmediata(
    ...
    await _notifications.show(999, titulo, mensaje, notificationDetails);
  }
}
